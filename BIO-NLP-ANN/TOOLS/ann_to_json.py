...
def convert(origen_ann, origen_txt, none):
    create_tokens(origen_ann, origen_txt)
    

def create_tokens(origen_ann, origen_txt):
    ...
    with open(origen_txt) as file:
        ...
        for line in file:
            ...
            data.append(actual_json) # En este punto tenemos un array de JSON con los tokens ya puestos.
...
if __name__ == '__main__':
    ...
    convert(args.origen_ann[0], args.origen_txt[0], "")

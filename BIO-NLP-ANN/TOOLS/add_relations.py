    ...
    with open(origen_ann) as file:
        for line2 in file:
            ...
            if tab_div[0][0] == "E":
                ...
                if len(content.split()) == 2 or len(content.split()) == 3 or len(content.split()) == 4:
                    end_piece = content.split()[-1]
                    relation_name, end_entity = end_piece.split(":")
                else:
                    end_entity = ""
                    print("Por alguna razon el contenido no es adecuado.")
                    print("En la linea:",line2)
                    pass
                ...
                if len(content.split()) != 1 and begin_entity in mapping.keys() and end_entity in mapping.keys():
